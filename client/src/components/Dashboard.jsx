            ...
            <div className="dash-inner">
                ...
                <div className="dash-stats-row">
                    <div className="dash-stat-card">
                        <div className="dash-stat-icon whatsapp">
                            <FaWhatsapp />
                        </div>
                    ...
                    <div className="dash-stat-card">
                        <div className="dash-stat-icon email">
                            <FaEnvelope />
                        </div>
                        <div className="dash-stat-body">
                    ...
                    <div className="dash-stat-card">
                        <div className="dash-stat-icon calls">
                            <FaPhone />
                        </div>
                        <div className="dash-stat-body">
                    ...
                    <div className={`dash-stat-card ${!aiConfigured ? 'dash-disabled-card' : ''}`}>
                        ...
                        <div className="dash-stat-icon ai">
                            <FaRobot />
                        </div>
                        <div className="dash-stat-body">
                    ...
                    <div className={`dash-leads-section ${!aiConfigured ? 'dash-disabled-section' : ''}`}>
                        {!aiConfigured && (
                            <div className="dash-section-overlay">
                                ...
                                <span className="dash-overlay-sub">Configure your AI provider in AI Config to enable sentiment analysis and lead scoring.</span>
                            </div>
                        )}
                        ...
                        <div className="dash-leads-grid">
                            <div className="dash-lead-column positive">
                                <h4><FaArrowUp /> Positive Interactions</h4>
                            ...
                            <div className="dash-lead-column negative">
                                <h4><FaArrowDown /> Negative Interactions</h4>
                                <div className="dash-lead-list">
                ...
                {sheetLeads.spreadsheetId && (
                    <div className="dash-section">
                        ...
                        {sheetLeads.loading ? (
                            ...
                            <p className="dash-empty-text">No leads extracted yet. Data will appear after AI processes conversations.</p>
                        )}
                    </div>
                )}
