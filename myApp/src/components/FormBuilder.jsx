...
export default function FormBuilder() {
    ...
    const [mobilePanelTab, setMobilePanelTab] = useState('canvas'); // fields, canvas, properties
                ...
                <IonContent className="ion-padding">
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <Layout size={48} color="#2B5EA7" style={{ marginBottom: '20px', margin: '0 auto 20px' }} />
                            <h2 style={{
                                fontSize: '24px',
                                fontWeight: '700',
                                color: '#1f2937',
                            ...
                            <p style={{
                                ...
                                🖥️ This feature is only accessible through desktop mode. Please open this page on a desktop or tablet to use the form builder.
                            </p>
                            <p style={{
                                fontSize: '14px',
                                color: '#9ca3af',
                                ...
                                The form builder requires a larger screen to work effectively.
                            </p>
                        </div>
                    </div>
                </IonContent>
        ...
        <IonPage>
            <IonContent>
                <div className="fb-container" style={{ overflow: 'hidden', height: '100vh', display: 'flex', flexDirection: 'column' }}>
                    ...
                    {/* Main Workspace */}
                    <div className="fb-workspace" data-panel={mobilePanelTab}>
                        {/* Sidebar Tools - Left Side */}
                        {activeTab === 'editor' && !selectedField && (
                            <div className="fb-sidebar fb-panel-fields">
                        ...
                        {/* Canvas */}
                        <div className="fb-canvas-area fb-panel-canvas" style={{ backgroundColor: '#f3f4f6' }}>
                                ...
                                <div className="fb-fields-container" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: '1rem' }}>
                                    {currentForm.fields.length === 0 ? (
                                        ...
                                        currentForm.fields.map((field, index) => (
                                            <div
                                                key={field.id}
                                                onClick={() => { setSelectedField(field); setActiveTab('editor'); setMobilePanelTab('properties'); }}
                        ...
                        <div className="fb-properties-panel fb-panel-properties">
                            {activeTab === 'design' ? (
                    ...
                    <div className="fb-mobile-tab-bar">
                        <button
                            className={`fb-mobile-tab ${mobilePanelTab === 'fields' ? 'active' : ''}`}
                            onClick={() => { setMobilePanelTab('fields'); setActiveTab('editor'); setSelectedField(null); }}
                        >
                            <Type size={18} />
                            <span>Fields</span>
                        </button>
                        <button
                            className={`fb-mobile-tab ${mobilePanelTab === 'canvas' ? 'active' : ''}`}
                        ...
                        <button
                            className={`fb-mobile-tab ${mobilePanelTab === 'properties' ? 'active' : ''}`}
                            onClick={() => { setMobilePanelTab('properties'); }}
                        >
                            <Settings size={18} />
                            <span>Style</span>
                        </button>
